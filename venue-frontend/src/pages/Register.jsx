      ...
      >
        ...
        <Card className="shadow-2xl border-borderSubtle/50 bg-bgCard/50 backdrop-blur-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-textMuted">Start booking expert venues today</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-textMuted">
            ...
            <Link to="/login" className="text-accentOrange hover:text-accentHover font-medium transition-colors">
              Sign in
            </Link>
          </div>
        </Card>
